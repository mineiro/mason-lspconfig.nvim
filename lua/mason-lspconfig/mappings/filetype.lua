...
return {
  ...
  toml = { "taplo" },
  twig = { "tailwindcss" },
  typescript = { "angularls", "cssmodules_ls", "custom_elements_ls", "denols", "ember", "eslint", "glint", "rome", "sourcery", "stylelint_lsp", "tailwindcss", "tsserver", "vtsls" },
  ["typescript.glimmer"] = { "ember", "glint" },
  ["typescript.tsx"] = { "angularls", "custom_elements_ls", "denols", "eslint", "rome", "tsserver", "vtsls" },
  typescriptreact = { "angularls", "cssmodules_ls", "custom_elements_ls", "denols", "emmet_language_server", "emmet_ls", "eslint", "graphql", "rome", "sourcery", "stylelint_lsp", "tailwindcss", "tsserver", "unocss", "vtsls" },
  typst = { "typst_lsp" },
  v = { "vls" },
  vala = { "vala_ls" },
